              ...
              >
                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded bg-white p-6 text-left shadow-xl transition-all">
                  ...
                  <div className="mt-4 flex justify-end gap-2">
                    ...
                    <Button className="bg-transparent hover:bg-transparent !text-primary !hover:text-accent " value={cancelLabel} onClick={fecharModal} />
                    <Button value={confirmLabel} onClick={confirmar} />
